package com.hui.pengtao.photoselectlibrary.cropview;
...
import com.hui.pengtao.photoselectlibrary.cropview.animation.SimpleValueAnimator;
import com.hui.pengtao.photoselectlibrary.cropview.animation.SimpleValueAnimatorListener;
import com.hui.pengtao.photoselectlibrary.cropview.animation.ValueAnimatorV14;
import com.hui.pengtao.photoselectlibrary.cropview.animation.ValueAnimatorV8;
import com.hui.pengtao.photoselectlibrary.cropview.callback.Callback;
import com.hui.pengtao.photoselectlibrary.cropview.callback.CropCallback;
import com.hui.pengtao.photoselectlibrary.cropview.callback.LoadCallback;
import com.hui.pengtao.photoselectlibrary.cropview.callback.SaveCallback;
import com.hui.pengtao.photoselectlibrary.util.Logger;
import com.hui.pengtao.photoselectlibrary.util.Utils;
...
public class CropImageView extends ImageView {
	...
	private void setupLayout(int viewW, int viewH) {
		...
		setCenter(new PointF(viewW * 0.5f, getPaddingTop() + viewH * 0.5f));
	...
	public Bitmap getCroppedBitmap() {
		...
		if (rotated != cropped && rotated != source && !rotated.isRecycled()) {
			rotated.recycle();
			System.gc();
			rotated = null;
		}
		...
		if (mCropMode == CropMode.CIRCLE) {
			...
			if (cropped != getBitmap() && !cropped.isRecycled()) {
				cropped.recycle();
				System.gc();
				cropped = null;
			}
